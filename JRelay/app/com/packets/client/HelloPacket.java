...
public class HelloPacket extends Packet {
	...
	public String toString() {
		return "HelloPacket [buildVersion=" + buildVersion + ", gameId=" + gameId + ", guid=" + guid + ", password="
				+ password + ", secret=" + secret + ", keyTime=" + keyTime + ", key=" + Arrays.toString(key)
				+ ", entryTag=" + entryTag + ", gameNet=" + gameNet + ", gameNetUserId=" + gameNetUserId
				+ ", playPlatform=" + playPlatform + ", platformToken=" + platformToken + ", userToken=" + userToken
				+ "]";
	}
}
